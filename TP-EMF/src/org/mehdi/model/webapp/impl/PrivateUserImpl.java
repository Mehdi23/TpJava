...
import org.mehdi.model.webapp.PrivateUser;
import org.mehdi.model.webapp.webappPackage;
 ...
 * <ul>
 *   <li>{@link org.mehdi.model.webapp.impl.PrivateUserImpl#getPassword <em>Password</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrivateUserImpl extends UserImpl implements PrivateUser {
	...
	protected EClass eStaticClass() {
		return webappPackage.Literals.PRIVATE_USER;
	}
	...
	public void setPassword(int newPassword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, webappPackage.PRIVATE_USER__PASSWORD, oldPassword, password));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case webappPackage.PRIVATE_USER__PASSWORD:
				return getPassword();
		}
