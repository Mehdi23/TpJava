...
public class TP-EMFPackageImpl extends EPackageImpl implements TP-EMFPackage {
	 ...
	 * @generated
	 */
	public EReference getLocation_Users() {
	 ...
	 * @generated
	 */
	public EReference getUser_Location() {
	...
	public void createPackageContents() {
		...
		createEReference(locationEClass, LOCATION__USERS);
	...
	public void initializePackageContents() {
		...
		initEReference(getLocation_Users(), this.getUser(), this.getUser_Location(), "users", null, 0, -1, Location.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
